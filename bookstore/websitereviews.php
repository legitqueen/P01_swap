...
<ul>
	...
	<li style="float:right"><a href="websitereviews.php">Website Review</a></li>
...
$query=$connect->prepare("select comment from comments");
$query->execute();
$query->bind_result($comment);
echo "<table align='center' border='1' cellpadding='20'>";
echo "<tr>";
echo "<th><h1>Website Reviews</h1></th>";
echo "</tr>";
while($query->fetch())
{
	echo "<center>";
...
?>
<br>
<center><a href="harwinderindex.php">Insert Comment</a></center>
</body>
</html>
<?php
}
